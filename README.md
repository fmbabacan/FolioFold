...
FolioFold v0.3.0 is distributed as separate notarized downloads for Apple Silicon and Intel Macs. Use Apple menu > About This Mac if the Mac architecture is unknown.
